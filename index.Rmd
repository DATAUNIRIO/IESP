...
subtitle: "Instituto de Estudos Sociais e Políticos (IESP)"
author: "prof. Alexandre Silva e prof. Steven Dutt-Ross"
output:
...
```{r MC100, echo=TRUE,warning=FALSE, message=FALSE}
...
```{r Reg10a, echo=TRUE, fig.width=7, fig.height=5, warning=FALSE, message=FALSE}
require(car)
...
```{r Reg11, echo=TRUE, warning=FALSE, message=FALSE}
library(car)
vif(modelo4)
...
```{r Reg19, echo=TRUE, warning=FALSE, message=FALSE}
library(car)
